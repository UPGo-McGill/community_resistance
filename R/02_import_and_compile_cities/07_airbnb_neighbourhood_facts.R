...
airbnb <- tibble(city = character(0), neighbourhood_name = character(0), active_listings = numeric(0), active_listings_avg = numeric (0), EH_pct = numeric (0), 
...
repeat{
  ...
  airbnb[n, 9] <-  st_drop_geometry(strr_ghost(property, Property_ID, Airbnb_HID, Created, Scraped, start_date,
