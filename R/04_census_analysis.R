...
# Use st_intersect_summarize to estimate values from census tracts at the neighbourhood scale
neighbourhoods <- 
map(neighbourhoods, ~{
  st_intersect_summarize(
    ...
    mean_vars = vars(med_income, population_z, households_z, med_income_z, university_education_z,
                     ...
                     citizen_z, white_z, low_income_z, lone_parent_z, university_education_pct_pop_z, 
                     housing_need_pct_household_z, non_mover_pct_pop_z, owner_occupied_pct_household_z,
                     rental_pct_household_z, language_pct_pop_z, citizen_pct_pop_z, white_pct_pop_z, 
